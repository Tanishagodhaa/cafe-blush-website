...
import AnimatedSection, { StaggerContainer, StaggerItem, HoverEffect } from '@/components/AnimatedSection';
...
export default function HomePage() {
  ...
  return (
    <>
          ...
          <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" staggerDelay={0.15}>
            {featuredItems.map((item) => (
              <StaggerItem key={item.id}>
                <HoverEffect scale={1.03} className="h-full">
      ...
      {/* Order Section */}
      <section className="section bg-blush-coral text-white overflow-hidden">
        <div className="container-custom">
          <AnimatedSection animation="scaleIn" className="text-center max-w-2xl mx-auto">
            ...
            <StaggerContainer className="flex flex-col sm:flex-row justify-center gap-4" staggerDelay={0.1}>
              <StaggerItem>
      ...
      <section className="section bg-blush-coral/20">
        <div className="container-custom">
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center" staggerDelay={0.15}>
            <StaggerItem>
              <HoverEffect scale={1.05} className="h-full">
            ...
            <StaggerItem>
              <HoverEffect scale={1.05} className="h-full">
                <div className="card h-full">
                  <div className="animate-bounce-subtle inline-block" style={{ animationDelay: '0.2s' }}>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blush-coral hover:underline text-sm mt-2 inline-block transition-transform hover:translate-x-1"
                  >
                    Get Directions →
                  </a>
                </div>
            ...
            <StaggerItem>
              <HoverEffect scale={1.05} className="h-full">
                <div className="card h-full">
                  <div className="animate-bounce-subtle inline-block" style={{ animationDelay: '0.4s' }}>
